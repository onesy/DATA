<?php
class DATAGlobalVars extends ArrayObject
{
    /**
     * 单件注册对象类的名字.
     * @var string
     */
    private static $_registryClassName = 'DATAGlobelVars';
     ...
     */
    public static function setInstance(DATAGlobalVars $registry)
    {
        if (self::$_registry !== null) {
            throw new Exception('DATAGlobalVars is already initialized');
        }
    ...
    protected static function init()
    {
        ...
        if($obj instanceof DATAGlobalVars) self::setInstance($obj);
    }
     ...
     */
    public static function setClassName($registryClassName = 'DATAGlobelVars')
    {
        if (self::$_registry !== null) {
            throw new Exception('DATAGlobalVars is already initialized');
        }
        ...
        if (!is_string($registryClassName) || !$registryClassName) {
            throw new ArgumentsException("Argument is not a class name");
        }
